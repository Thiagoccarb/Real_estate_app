...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        None, "addresses", "cities", ["city_id"], ["id"], ondelete="CASCADE"
    )
    op.drop_constraint("images_ibfk_1", "images", type_="foreignkey")
    op.create_foreign_key(
        None, "images", "properties", ["property_id"], ["id"], ondelete="CASCADE"
    )
    op.drop_constraint("properties_ibfk_1", "properties", type_="foreignkey")
    op.create_foreign_key(
        None, "properties", "addresses", ["address_id"], ["id"], ondelete="CASCADE"
    )
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        "properties_ibfk_1", "properties", "addresses", ["address_id"], ["id"]
    )
    op.drop_constraint(None, "images", type_="foreignkey")
    op.create_foreign_key(
        "images_ibfk_1", "images", "properties", ["property_id"], ["id"]
    )
    op.drop_constraint(None, "addresses", type_="foreignkey")
    op.create_foreign_key(
        "addresses_ibfk_1", "addresses", "cities", ["city_id"], ["id"]
    )
    # ### end Alembic commands ###
